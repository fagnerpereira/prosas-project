...
# Creating Grades
grade_1 = Grade.find_or_create_by!(grade: 95.0, evaluation: evaluation_1, criterion: criterion_1)
grade_2 = Grade.find_or_create_by!(grade: 95.0, evaluation: evaluation_1, criterion: criterion_2)
grade_3 = Grade.find_or_create_by!(grade: 95.0, evaluation: evaluation_1, criterion: criterion_3)
