...
class EvaluationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create evaluation" do
    assert_difference("Evaluation.count") do
      post evaluations_url, params: { evaluation: { project_id: @evaluation.project_id, weighted_average: @evaluation.weighted_average } }
    end
  ...
  test "should update evaluation" do
    patch evaluation_url(@evaluation), params: { evaluation: { project_id: @evaluation.project_id, weighted_average: @evaluation.weighted_average } }
