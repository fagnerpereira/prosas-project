...
class GradesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create grade" do
    assert_difference("Grade.count") do
      post grades_url, params: { grade: { criterion_id: @grade.criterion_id, evaluation_id: @grade.evaluation_id, grade: @grade.grade } }
    end
  ...
  test "should update grade" do
    patch grade_url(@grade), params: { grade: { criterion_id: @grade.criterion_id, evaluation_id: @grade.evaluation_id, grade: @grade.grade } }
